...
namespace IcoFarma
{
    public partial class frmClientes : Form
    {
        ...
        private void dgvdata_CellContentClick_2(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnDNI_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dynamic respuesta = program.Get("https://dniruc.apisperu.com/api/v1/dni/" + txtdocumento.Text + "?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6Im4wMDI4MTQxN0B1cG4ucGUifQ.ki-Pu1f7QQ1Y9L_ynmClHmUgpyDDFXSBBpmOwJtsr8c");
                    txtnombrecompleto.Text = respuesta.nombres.ToString() + " " + respuesta.apellidoPaterno.ToString() + " " + respuesta.apellidoMaterno.ToString();
                }
